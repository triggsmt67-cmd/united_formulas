    ...
    return (
        <div className="group relative rounded-2xl p-[1px] h-full">
            ...
            >
                <div className="aspect-[4/3] w-full overflow-hidden rounded-xl bg-white/[0.03] border border-white/5 mb-6 relative group/img shadow-inner">
                    ...
                    {product.image?.sourceUrl && (
                        <Image
                            ...
                            fill
                            className="object-contain p-10 transition-all duration-700 group-hover/img:scale-110 group-hover/img:brightness-110"
                        />
                    )}
                </div>
                <div className="flex items-center gap-3 mb-4">
                    <span className="text-xs font-bold tracking-[0.2em] text-cyan-500/80 uppercase">
                ...
                <div
                    className="text-slate-400 text-base leading-relaxed mb-8 flex-grow line-clamp-3"
                    dangerouslySetInnerHTML={{ __html: product.shortDescription || "" }}
                />
                <div
                    className="w-full py-4 rounded-lg border border-slate-700/50 bg-slate-800/50 text-slate-300 group-hover:text-white group-hover:border-cyan-500/50 group-hover:bg-slate-800 transition-all text-sm font-bold text-center uppercase tracking-widest"
                >
                    More Info
                </div>
            </Link>
